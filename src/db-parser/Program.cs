...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        await context.Database.ExecuteSqlRawAsync(
            "delete from planet_positions7 where to_char(\"Time\", 'HH24:MI:SS') LIKE '00:00:00'");
    ...
    {
        var startingTime = DateTime.Parse("2010-01-01 00:00:00"); // TODO: Hardcoded starting time
